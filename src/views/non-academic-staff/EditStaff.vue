     ...
     <div>
        <div class="card">
            <div class="card-body">
                ...
                <h4> Non Academic Staff information Edit</h4>
                    ...
                    <div>
                     ...
                     <div>
                      ...
                      <div>
                        <div class="row my-3">
                            <div class="col">
                                <label for="formGroupExampleInput" class="form-label">Job Type</label>
                                <input type="text" class="form-control" v-model.trim="$v.items.jobtype.$model" :class="{'is-invalid': validationStatus($v.items.jobtype)}" placeholder=" " aria-label="First name">
                                <div v-if="!$v.items.jobtype.required" class="text-danger"><small>  Text is required.</small></div>
...
export default {
    ...
    data: function() { //data()
        ...
        getData(){
             ...
             this.$http.get('http://localhost:8090/api/staff/find/'+this.$route.params.id)
...
console.log(this.items)
        ...
        submitForm() {
            ...
            if(this.$v.items.$pendding || this.$v.items.$error) {
                ...
                this.$http.put('http://localhost:8090/api/staff/'+this.$route.params.id, staff) .then(function (Response){
